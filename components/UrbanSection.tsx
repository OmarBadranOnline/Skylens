...
export const UrbanSection: React.FC = () => {
  return (
    <section className="relative h-screen w-full bg-black overflow-hidden border-t border-zinc-900">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <iframe
          ...
          src="https://www.youtube.com/embed/7t0E8o1FhE8?autoplay=1&mute=1&loop=1&playlist=7t0E8o1FhE8&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&start=10"
          title="Urban Background"
      ...
      <div className="relative z-20 w-full h-full container mx-auto px-6 md:px-12 flex items-center justify-start">
          ...
          >
             <div className="flex items-center gap-3 mb-4">
                <span className="text-cyan-500 font-mono text-xs tracking-widest uppercase">Sec.03 // Neon</span>
             ...
             <h2 className="font-display text-5xl md:text-7xl lg:text-8xl font-black text-white italic tracking-tighter drop-shadow-2xl leading-[0.9] mb-6 py-2">
                NEON<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600 pr-4">PULSE</span>
             </h2>
             
             <p className="text-gray-300 font-mono text-xs md:text-sm tracking-[0.3em] uppercase border-l-2 border-cyan-500 pl-6 max-w-md">
               Vertical Perspectives. Diving through the concrete jungle.
             </p>
          </motion.div>
      ...
      <div className="absolute bottom-0 w-full z-30 pointer-events-none">
         ...
         <div className="flex justify-between px-6 pb-4 pt-2">
             <span className="text-[10px] text-cyan-500/50 font-mono">DENSITY: HIGH</span>
             <span className="text-[10px] text-cyan-500/50 font-mono">SIGNAL: 5G // STRONG</span>
         </div>
      </div>
    </section>
  );
