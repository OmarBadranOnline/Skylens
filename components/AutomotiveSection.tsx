    ...
    <section className="relative h-screen w-full bg-black overflow-hidden border-t border-zinc-900">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <iframe
          ...
          src="https://www.youtube.com/embed/uN8h3X6gXwE?autoplay=1&mute=1&loop=1&playlist=uN8h3X6gXwE&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&start=15"
          title="Drift FPV Background"
      ...
      <div className="relative z-20 w-full h-full container mx-auto px-6 md:px-12 flex items-center justify-start">
          ...
          >
             <div className="flex items-center gap-3 mb-4">
                <span className="text-red-500 font-mono text-xs tracking-widest uppercase">Sec.01 // Drift</span>
             ...
             <h2 className="font-display text-5xl md:text-7xl lg:text-8xl font-black text-white italic tracking-tighter drop-shadow-2xl leading-[0.9] mb-6 py-2">
                DRIFT<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-600 pr-4">SERIES</span>
             </h2>
             
             <p className="text-gray-300 font-mono text-xs md:text-sm tracking-[0.3em] uppercase border-l-2 border-red-600 pl-6 max-w-md">
               Precision Proximity @ 150km/h. Pushing the limits of FPV dynamics.
             </p>
          </motion.div>
